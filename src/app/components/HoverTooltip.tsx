...
export const tooltipMessages: Record<string, string> = {
  ...
  "services": "See what I can build.",
  "projects": "Review featured work.",
  "about": "See how I work.",
  "work": "Go to the work section.",
  "contact": "Start the conversation.",
  "games": "Open the game overlay.",
  "terms & conditions": "Review terms and refund coverage.",
  "privacy policy": "See how project and inquiry data is handled.",
  "back to portfolio": "Return to the main portfolio.",
  "back to home": "Return to the homepage.",
  ...
  "linkedin": "Ready to connect.",
  "github": "Review repositories and shipped code.",
