...
export interface PostPurchaseFormProps {
...
/**
 * Inline post-purchase form used on /products/success.
 */
export function PostPurchaseForm({
  ...
  return (
    <section className="mx-auto flex w-full max-w-5xl flex-col rounded-xl border border-border bg-background shadow-sm">
      ...
      <div className="space-y-4 px-5 py-4 sm:space-y-5">
        {loading && (
              ...
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                ...
                <div className="space-y-1">
                  ...
                  <select
                    ...
                    onChange={(event) =>
                      patchSafeConfig("booking_mode", event.target.value as SafeConfigInput["booking_mode"])
                    }
